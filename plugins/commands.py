    ...
    if usr_cmdall1.startswith("/start SenuInfinity"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=cmd.from_user.id,
                    text="**ඔයා අපේ Channel එකට තාම Join වෙලා නෑ 💔 . මුලින්ම ඒකට Join වෙලා ඉන්න 👇!**",
...
async def bot_info(bot, message):
    ...
    await message.reply(text=f"<b>👋Hi,\nI am Very Powerfull Movie Filter\n\nAbout Me 🗯\n🔬Language : <code>Python3</code>\n📚Library : <a href='https://docs.pyrogram.org/'>Pyrogram</a>\nAct : 🔐\nSup: <a href='{TUTORIAL}'>Click here</a>\nUpdates : <a href='https://t.me/NFLK_UpdatesX'>Click here</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
